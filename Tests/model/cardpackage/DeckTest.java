...
public class DeckTest {
  ...
  public void drawCard() {
    ...
    assertFalse("the dranw card was not removed from the Deck",
        chanceDeck.getDeck().stream().anyMatch(card -> card == drawnCard));
  }
  ...
  public void returnCard() {
    ...
    assertTrue("the drawn card was not removed from the Deck",
        chanceDeck.getDeck().stream().anyMatch(card -> card == drawnCard));
  }
  ...
  public void shufleDeck() {
    ...
    assertFalse("The deck did not get shuffled",
        chanceDeck.getDeck().get(randomCardIndex).equals(randomCard));
  }
