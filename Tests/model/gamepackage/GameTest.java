...
public class GameTest {
  ...
  public void getBankTest() throws Exception {
    PropertySquare propertySquare = new PropertySquare("GVSU", 5, 200, 400,
        100, 200, 300, 400, 500,
        600, 2, 100, 500, 2);
    ArrayList<OwnableSquare> properties = new ArrayList<OwnableSquare>() {{
      add(propertySquare);
    }};
  ...
  public void getComunityChestDeckTest() {
    ...
    assertFalse(game.getComunityChestDeck().getDeck()
        .contains(comunityChestDeck.getDeck().get(0).getCardDescription()));
  ...
  public void getChanceDeckTest() {
    ...
    assertFalse(game.getComunityChestDeck().getDeck()
        .contains(chanceDeck.getDeck().get(0).getCardDescription()));
  ...
  public void checkIfOwnableTest() {
    assertEquals(game.getBoard().getSquaresList().get(1),
        game.checkIfOwnable(game.getBoard().getSquaresList().get(1)));
  }
