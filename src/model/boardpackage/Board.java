...
public class Board {
  ...
  /**
   * The list of all squares in the board.
   */
  ...
  /**
   * Returns the specific list of locations based on their type.
   * @param typeId The type of the BoardSquare.
   *
   * @return The list of BoardSquares.
   */
